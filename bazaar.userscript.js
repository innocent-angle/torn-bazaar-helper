...
(async() => {
    ...
    async function fillAll(container) { 
    ...
    async function fill(child) {
        const itemName = child.querySelector("div.title-wrap.relative div.name-wrap.bold span.t-overflow").textContent;
